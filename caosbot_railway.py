...
try:
    ...
    from xp_system import setup_xp_system, process_xp_gain
...
<head>
    ...
    <style>
        ...
        * {{
        ...
        .card {{ background: linear-gradient(135deg, rgba(0, 0, 0, 0.6) 0%, rgba(0, 20, 50, 0.4) 100%); backdrop-filter: blur(10px); border: 2px solid #0066ff; border-radius: 0; padding: 24px; padding-bottom: 24px; margin-bottom: 0; transition: all 0.3s; box-shadow: 0 4px 16px rgba(0, 100, 255, 0.3); will-change: transform; transform: translateZ(0); contain: layout style paint; width: 100%; max-width: 100%; box-sizing: border-box; word-wrap: break-word; overflow-wrap: break-word; }}
        ...
        .section {{ margin-bottom: 32px; width: 100%; box-sizing: border-box; max-width: 100%; overflow-x: hidden; }}
                        ...
                        <div id="giveaway-fields" style="display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 10px;">
                                    <input type="number" id="giveaway-duration" class="form-input" placeholder="Ex: 7" min="1" value="7" oninput="updateEmbedPreview()" onkeyup="updateEmbedPreview()">
...
📋 Abra um ticket na categoria 🎉 **Sorteios** para receber seu prêmio.</textarea>
    ...
    <script>
        ...
        // Atualizar mensagem do Robito
        function updateRobitoHelper(page) {{
        ...
        function showPage(page) {{
            ...
            // Atualizar Robito Helper
            updateRobitoHelper(page);
...
if XP_SYSTEM_ENABLED:
    try:
        # Configurar hook de mensagens para XP
        setup_xp_system(bot)
